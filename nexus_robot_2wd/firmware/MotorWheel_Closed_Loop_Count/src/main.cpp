...
#include <nexus_robot_msgs/EncoderDataStamped.h>
...
nexus_robot_msgs::EncoderDataStamped Encoder_Count;
...
void publish_rps()
{
  ...
  Encoder_Count.leftcount  = encoderL1;
  Encoder_Count.rightcount = encoderR1;
